...
// template<typename Type>
// Matrix<Type>::Matrix(size_t const &rows, size_t const &columns)
...
// template<typename Type>
// Matrix<Type>::Matrix(const size_t& rows, const size_t& columns, const Type& fill) {
//     this->rows = rows;
//     this->columns = columns;
...
// template<typename Type>
// Matrix<Type>::Matrix(std::initializer_list<std::vector<Type>> c): _matrix{c} {
//     this->rows = this->_matrix.size();
//     this->columns = this->_matrix[0].size();
// }

// template<typename Type> template<typename Iter>
// Matrix<Type>::Matrix(Iter begin, Iter end)
// : _matrix(begin, end) {
//     this->rows = this->_matrix.size();
//     this->columns = this->_matrix[0].size();
// }
...
// template<typename Type>
// std::vector<Type>& Matrix<Type>::operator[](size_t const index) const {
...
// template<typename... Type>
// Polynomial::Polynomial(const std::string& symbol, Type... args)
